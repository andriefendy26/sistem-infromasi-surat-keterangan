...
<body>
    <div class="noreg">No.Reg: {{$surat->no_reg}}</div>
    <div class="header">
    ...
    <div class="sub-title">
       <p>Yang bertanda tangan di bawah ini <strong>{{ $surat->dokter->nama }}</strong> dokter pada Pusat Kesehatan Masyarakat (PUSKESMAS) Pantai Amal, Kecamatan Tarakan Timur, dalam menjalankan tugas mengingat Sumpah jabatan menerangkan :</p>
    </div>
    ...
    <div class="content">
        <div class="section">
            ...
            <div class="data-row">
                <table>
                    <tr>
                        <td class="data-label">Status Gizi</td>
                        @php
                            $options = [
                                'Kurus',
                                '/',
                        ...
                        {{-- <td class="data-value">: {{ $surat ? $surat->status_gizi : 'Belum diisi' }}</td> --}}
                    </tr>
                </table>
            </div>
            <div class="data-row">
            ...
            <div class="data-row">
                <table>
                    <tr>
                        <td class="data-label">Kesimpulan</td>
                        <td class="data-value">: {{ $surat ? $surat->kesimpulan : 'Belum diisi' }}</td>
                    </tr>
                </table>
            </div>
            <div class="data-row">
                <table>
                    <tr>
                        ...
                        <td class="data-value">: {{ $surat ? $surat->golongan_darah : 'Belum diisi' }}</td>
                    </tr>
                </table>
            </div>
            <div class="data-row">
                <table>
                    <tr>
                        <td class="data-label">Hasil tes buta warna</td>
                        <td class="data-value">: {{ $surat ? $surat->hasil_tes_buta_warna : 'Belum diisi' }}</td>
                    </tr>
                </table>
            </div>
                ...
                <td width="50%" class="table-right">
                    <div class="signature-box">
                        ...
                        <div class="signature-id">
                            @if(!empty($surat->dokter->nip))
                                NIP. {{ $surat->dokter->nip }}
                            @elseif(!empty($surat->dokter->sipd))
                                SIPD. {{ $surat->dokter->sipd }}
                            @else
                                -
                            @endif
                        </div>
